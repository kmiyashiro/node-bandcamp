 ...
 * Each module can be included individually. You can even assign different
 * keys and versions to each module, not sure why you'd want to do that.
 *
 * @param {String} key Bandcamp API key, email <support@bandcamp.com> to
 *  request one.
 * @param {Object} [vers] An object to override the different versions of each
 *  module. You probably don't want to touch this.
 * @return {Object} Bandcamp API client. See test/test.js to see example
 *  usage.
 */
...
var exports = module.exports = function(key, vers) {
    ...
    return {
        ...
        _qs: require('./core')(key)._qs // expose for testing
    };
